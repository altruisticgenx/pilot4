          ...
          {isLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {experiments.map((exp) => {
                ...
                return (
                  <Card key={exp.id} className="border-2 hover:border-primary/30 transition-all hover:shadow-lg group">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        {exp.demo_url && <Button variant="ghost" size="sm" asChild></Button>}
                        {exp.repo_url && <Button variant="ghost" size="sm" asChild></Button>}
                      </div>
                    </CardContent>
                  </Card>
                );
